...
gh release create v2026.07.03.1 \
  ...
  --latest \
  --notes "EPUB artifact, release manifest, completion report, user style diff report, resource manifests, orphan-page report, nav-target fix report, TradeCatLabs notice report, and audit report."
```
